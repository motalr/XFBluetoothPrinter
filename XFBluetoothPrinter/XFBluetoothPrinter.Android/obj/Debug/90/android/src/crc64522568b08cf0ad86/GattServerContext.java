...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Shiny.BluetoothLE.Peripherals.Internals.GattServerContext, Shiny.BluetoothLE", GattServerContext.class, __md_methods);
	}
	...
	public GattServerContext ()
	{
		...
		if (getClass () == GattServerContext.class)
			mono.android.TypeManager.Activate ("Shiny.BluetoothLE.Peripherals.Internals.GattServerContext, Shiny.BluetoothLE", "", this, new java.lang.Object[] {  });
	}
